...
void assert_eq(const String &str, const std::string &expected) {
...
int main() {
  ...
  assert_eq(s1, expected_result_2);

  s1.insert('d');
  s1.insert('e');
  s1.insert('f');
  std::string expected_result_3 = "abcdef";
  assert_eq(s1, expected_result_3);

  s1.erase(1, 3);
  std::string expected_result_4 = "aef";
  assert_eq(s1, expected_result_4);

  s1.erase(1, 2);
  std::string expected_result_5 = "a";
  assert_eq(s1, expected_result_5);
